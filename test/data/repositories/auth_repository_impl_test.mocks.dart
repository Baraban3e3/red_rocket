...
// in red_rocket/test/data/repositories/auth_repository_impl_test.dart.
...
import 'package:red_rocket/data/api/auth_api.dart' as _i4;
import 'package:red_rocket/data/models/auth_response.dart' as _i2;
...
class MockAuthApi extends _i1.Mock implements _i4.AuthApi {
  ...
  @override
  _i5.Future<_i2.AuthResponse> login(Map<String, dynamic>? body) =>
      (super.noSuchMethod(
        Invocation.method(
          #login,
          [body],
